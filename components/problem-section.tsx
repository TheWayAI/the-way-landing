      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 mb-12">
          <p className="text-lg md:text-xl text-slate-300 leading-relaxed text-center">
            We've outsourced spiritual formation to Sunday sermons, devotional apps, therapy culture, and algorithm-fed theology. Passive consumption with no accountability. Spiritual snacking with no roots. Self-soothing without sanctification. Vibes over doctrine, feelings over truth.
          </p>
